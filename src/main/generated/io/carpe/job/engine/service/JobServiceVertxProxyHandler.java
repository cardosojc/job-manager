    ...
    try{
      ...
      switch (action) {
        case "getAllJobEvents": {
          ...
          try {
            service.getAllJobEvents((java.lang.String)ApiHandlerUtils.searchInJson(params, "code"),
                            context,
                            res -> {
                            if (res.failed()) {
        ...
        case "registerJob": {
          ...
          JsonObject params = context.getParams();
          try {
            service.registerJob(ApiHandlerUtils.searchOptionalJsonObjectInJson(params, "body").map(j -> new io.carpe.job.dto.JobRegisterRequest(j)).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
